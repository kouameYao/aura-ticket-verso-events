          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="font-playfair text-3xl md:text-4xl font-bold mb-6">
                <span className="text-gradient">Créez et vendez</span>
                <br />
                vos propres événements
              </h2>

              <p className="text-off-white/90 text-lg mb-8 leading-relaxed">
                Vous organisez des événements ? AuraTickets vous offre une
                plateforme premium pour créer, gérer et promouvoir vos
                événements avec facilité. Rejoignez notre communauté
                d'organisateurs et donnez vie à vos projets.
              </p>
