        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12">
          <div>
            ...
            <p className="text-off-white/70 max-w-2xl">
              Réservez vos places pour les événements les plus attendus de
              l'année.
            </p>
          </div>
          <Link to="/events">
            <Button className="mt-6 md:mt-0 bg-gold hover:bg-gold/80 text-rich-black font-semibold transition-all duration-300">
