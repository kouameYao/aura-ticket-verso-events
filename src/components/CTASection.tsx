      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="font-playfair text-4xl md:text-5xl font-bold mb-6">
            <span className="text-gold">Ne manquez plus</span> vos événements
            préférés
          </h2>

          <p className="text-off-white/90 text-lg mb-10 leading-relaxed">
            Inscrivez-vous maintenant pour recevoir en avant-première les
            annonces d'événements exclusifs et bénéficiez d'offres VIP réservées
            à nos membres.
          </p>
