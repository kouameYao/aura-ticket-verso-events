...
const Hero = () => {
  const backgroundImage =
    "public/lovable-uploads/9cb67d57-19bb-4085-92eb-ee4d986fad2b.png";
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            <h1 className="font-playfair text-5xl md:text-7xl font-bold mb-6 text-gold">
              Votre Accès aux Grands Événements
            </h1>
            <p className="text-lg md:text-xl text-off-white/90 mb-8 max-w-2xl">
              Vos tickets pour les événements, en un clic, sans stress.
            </p>
            <div className="flex flex-wrap gap-4">
              ...
              <Button
                ...
                asChild
              >
                <Link to="/#events">En savoir plus</Link>
              </Button>
            </div>
          </div>
        </div>
