  ...
  const sliderData: SliderItem[] = [
    {
      ...
      description:
        "Vivez des moments de musique inoubliables avec nos billets premium pour les concerts les plus attendus.",
      cta: "Découvrir",
    },
    {
      image:
      ...
      description:
        "Soyez au cœur de l'action avec des places privilégiées pour les plus grands événements sportifs du monde.",
      cta: "Explorer",
    },
    {
      image:
      ...
      description:
        "Émerveillez-vous devant les plus grands spectacles et pièces de théâtre avec notre sélection de billets VIP.",
      cta: "Réserver",
    },
  ];
