    ...
    <div className="min-h-screen bg-rich-black">
      ...
      <section className="pt-32 pb-20 relative">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1603190287605-e6ade32fa852?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80')",
          }}
        ></div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-off-white/80 text-lg md:text-xl leading-relaxed">
              Votre partenaire de confiance pour découvrir et réserver les
              événements les plus exclusifs.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-off-white/80 mb-6 leading-relaxed">
                AuraTickets est née d'une vision simple : transformer
                l'expérience d'achat de billets en ligne en un moment agréable
                et premium. Nous avons constaté que trop souvent, l'achat de
                billets était synonyme de frustration, de files d'attente
                virtuelles interminables et d'interfaces confuses.
              </p>
              <p className="text-off-white/80 mb-6 leading-relaxed">
                Fondée en 2022 par une équipe passionnée d'amateurs d'événements
                et d'experts en technologie, notre plateforme a été conçue pour
                offrir une expérience fluide et élégante, à l'image des
                événements de qualité que nous proposons.
              </p>
              <p className="text-off-white/80 leading-relaxed">
                Aujourd'hui, nous sommes fiers de connecter des milliers de
                participants à des événements exclusifs dans toute la France,
                avec une approche qui privilégie la qualité, la transparence et
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-off-white/80 text-lg leading-relaxed">
              Nous avons pour mission de démocratiser l'accès aux événements de
              qualité tout en offrant une expérience premium de bout en bout,
              depuis la découverte jusqu'à la participation.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-black/30 p-8 rounded-lg border border-titanium/30 hover:border-gold transition-all">
              ...
              <p className="text-off-white/70">
                Nous ne proposons que des événements soigneusement sélectionnés
                et nous nous efforçons d'offrir un service impeccable à chaque
                étape.
              </p>
            </div>
            ...
            <div className="bg-black/30 p-8 rounded-lg border border-titanium/30 hover:border-gold transition-all">
              ...
              <p className="text-off-white/70">
                ...
                rendre l'expérience de réservation plus intuitive et agréable.
              </p>
            </div>
            ...
            <div className="bg-black/30 p-8 rounded-lg border border-titanium/30 hover:border-gold transition-all">
              ...
              <p className="text-off-white/70">
                La transparence et la sécurité sont au cœur de notre approche,
                garantissant une tranquillité d'esprit totale à nos
                utilisateurs.
              </p>
            </div>
          </div>
