...
const events: EventProps[] = [
  ...
  },
  {
    ...
    description:
      "Assistez à ce tournoi international de tennis où les meilleurs joueurs du monde s'affrontent dans des matchs palpitants. Vivez l'excitation de chaque échange et soutenez vos joueurs favoris dans cette compétition de haut niveau.",
  },
  {
    id: 3,
    ...
    description:
      "Découvrez les œuvres fascinantes d'artistes contemporains lors de cette exposition d'art moderne. Une immersion dans l'univers créatif qui repousse les limites de l'expression artistique et vous invite à réfléchir sur notre monde actuel.",
  },
  {
    id: 4,
    ...
    description:
      "Laissez-vous emporter par l'énergie électrisante de ce concert de rock live. Des guitares enflammées, des rythmes puissants et une atmosphère survoltée vous attendent pour une soirée inoubliable pleine d'émotions et de passion musicale.",
  },
  {
    id: 5,
    ...
    description:
      "Émerveillez-vous devant les prouesses extraordinaires des artistes du Cirque du Monde. Acrobaties vertigineuses, numéros poétiques et performances à couper le souffle se succèdent dans ce spectacle féérique qui ravira petits et grands.",
  },
  {
    id: 6,
  ...
  },
  {
    ...
    description:
      "Dansez jusqu'au bout de la nuit lors de ce festival électronique incontournable. Les meilleurs DJs internationaux, des jeux de lumières spectaculaires et une ambiance survoltée vous promettent une expérience sensorielle complète.",
  },
  {
    id: 8,
    ...
    description:
      "Explorez les technologies de demain lors de cette conférence animée par des experts visionnaires. Intelligence artificielle, réalité virtuelle et innovations disruptives sont au programme de cet événement incontournable pour les passionnés de tech.",
  },
  {
    id: 9,
        ...
        <div className="container mx-auto px-4 py-20 flex-1 flex items-center justify-center">
          <div className="text-center glassmorphism p-10 rounded-lg">
            ...
            <p className="text-off-white/70 mb-8">
              L'événement que vous recherchez n'existe pas ou a été déplacé.
            </p>
            <Link to="/">
    ...
    <div className="min-h-screen bg-rich-black flex flex-col">
      ...
      <div className="bg-gradient-to-b from-black to-rich-black pt-24 pb-8">
        <div className="container mx-auto px-4">
          <Link
            to="/"
            className="inline-flex items-center text-off-white/70 hover:text-gold mb-6 transition-colors"
          >
          ...
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="flex gap-2">
              <Button
                variant="outline"
                size="icon"
                className="rounded-full bg-transparent border-titanium/30 hover:bg-titanium/20"
              >
