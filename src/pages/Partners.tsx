  ...
  const benefits = [
    {
      ...
      description: "Présentez vos événements en tête de liste et bénéficiez d'une mise en avant sur notre page d'accueil."
    },
    {
      icon: <Zap className="h-12 w-12 text-gold" />,
      title: "Outils avancés",
      description: "Accédez à des outils de gestion et d'analyse exclusifs pour maximiser vos ventes de billets."
    },
    {
      icon: <Shield className="h-12 w-12 text-gold" />,
      title: "Support dédié",
      description: "Un gestionnaire de compte personnel vous accompagne pour optimiser vos campagnes de billetterie."
    },
    {
      icon: <BarChart3 className="h-12 w-12 text-gold" />,
      title: "Insights détaillés",
      description: "Obtenez des rapports analytiques complets sur les performances de vos événements et le comportement des acheteurs."
    }
  ];
    ...
    <div className="min-h-screen bg-rich-black">
      ...
      <section className="pt-32 pb-20 relative">
        <div className="absolute inset-0 bg-cover bg-center opacity-20"
             style={{ backgroundImage: "url('https://images.unsplash.com/photo-1515187029135-18ee286d815b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80')" }}></div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-off-white/80 text-lg md:text-xl leading-relaxed">
              Découvrez les lieux emblématiques et organisateurs prestigieux qui nous font confiance pour leur billetterie.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {partners.map((partner, index) => (
              <div key={index} className="bg-black/30 p-6 rounded-lg border border-titanium/30 hover:border-gold transition-all group">
                ...
                <div className="text-center">
                  ...
                  <p className="text-off-white/60 text-sm">{partner.category}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-off-white/80 mb-8">
              Rejoignez notre réseau d'organisateurs premium et bénéficiez d'avantages exclusifs pour la distribution de vos billets.
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            {benefits.map((benefit, index) => (
              <div key={index} className="bg-black/30 p-8 rounded-lg border border-titanium/30 hover:border-gold transition-all">
                <div className="flex flex-col items-center text-center">
                  <div className="mb-6">{benefit.icon}</div>
                  <h3 className="font-playfair text-xl font-semibold mb-4 text-gold">{benefit.title}</h3>
      ...
      <section className="py-16 bg-rich-black">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                quote: "AuraTickets a transformé notre approche de la billetterie en ligne. Leur plateforme intuitive nous a permis d'augmenter nos ventes de 30% dès le premier mois.",
                author: "Marie Dufour",
                position: "Directrice, Festival Jazz à Paris"
              },
              {
                quote: "Le niveau de personnalisation et le support client sont incomparables. Notre public apprécie particulièrement la facilité d'achat et la sécurité.",
                author: "Thomas Leroy",
                position: "Responsable Événements, Stade Lyon"
              },
              {
                quote: "Depuis que nous utilisons AuraTickets, nos événements sont systématiquement complets. La visibilité offerte par la plateforme est exceptionnelle.",
                author: "Claire Martin",
                position: "Fondatrice, Théâtre Moderne"
              }
            ].map((testimonial, index) => (
              <div key={index} className="glassmorphism p-8 rounded-lg relative">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-off-white/60 text-sm">{testimonial.position}</p>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-off-white/90 text-lg mb-8">
              Donnez à vos événements la visibilité qu'ils méritent et simplifiez votre processus de billetterie.
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Button size="lg" className="bg-gold text-rich-black hover:bg-gold/80 text-lg px-8" asChild>
